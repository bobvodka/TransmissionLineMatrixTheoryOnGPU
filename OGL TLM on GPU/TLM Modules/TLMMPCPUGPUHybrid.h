...
/*	for visualisation													*/
/************************************************************************/
#ifndef OGLTLM_TLMMPCPUGPUHYBRID_H
#define OGLTLM_TLMMPCPUGPUHYBRID_H
...
namespace TLM
{
	class TLMMPCPUGPUHybrid : public ITLMRenderer
	{
	public:
		TLMMPCPUGPUHybrid(GLuint internalformat, Mesh::IMesh &sourceMesh);
		~TLMMPCPUGPUHybrid();
